...
Summary: Type annotations for boto3.RedshiftDataAPIService 1.21.0 service generated by mypy-boto3-builder 7.0.4
...
Once the `conda-forge` channel has been enabled, `mypy-boto3-redshift-data` can be installed with:

```
conda install mypy-boto3-redshift-data
```

It is possible to list all of the versions of `mypy-boto3-redshift-data` available on your platform with:
